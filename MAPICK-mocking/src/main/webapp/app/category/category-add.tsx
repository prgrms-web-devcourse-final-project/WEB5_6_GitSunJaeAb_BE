...
export default function CategoryAdd() {
  ...
  const [roadmapCategoryRelationsValuesResponse, setRoadmapCategoryRelationsValues] = useState<Map<number,string>>(new Map());
  ...
  const prepareRelations = async () => {
    try {
      const roadmapCategoryRelationsValuesResponse = await axios.get('/categories/roadmapCategoryRelationsValuesResponse');
