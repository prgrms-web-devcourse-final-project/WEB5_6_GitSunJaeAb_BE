    ...
    <div className="flex flex-wrap mb-6">
      ...
      <div>
        <Link to="/categories/add"
              className="inline-block text-white bg-blue-600 hover:bg-blue-700 focus:ring-blue-300  focus:ring-4 rounded px-5 py-2">{t('category.list.createNew')}</Link>
      </div>
    </div>
        ...
        <div className="overflow-x-auto">
          <table className="w-full">
            ...
            <tr>
              ...
              <th scope="col" className="text-left p-2">{t('category.description.label')}</th>
                  ...
                  <td className="p-2">
                    <div className="float-right whitespace-nowrap">
                      <Link to={'/categories/edit/' + category.id}
                            className="inline-block text-white bg-gray-500 hover:bg-gray-600 focus:ring-gray-200 focus:ring-3 rounded px-2.5 py-1.5 text-sm">{t('category.list.edit')}</Link>
                      <span> </span>
                      <button type="button" onClick={() => confirmDelete(category.id!)}
                              className="inline-block text-white bg-gray-500 hover:bg-gray-600 focus:ring-gray-200 focus:ring-3 rounded px-2.5 py-1.5 text-sm">{t('category.list.delete')}</button>
                    </div>
                  </td>
                </tr>
            ))}
