package com.gitsunjaeab.mapick.layer_library.controller;

import com.gitsunjaeab.mapick.layer.entity.Layer;
import com.gitsunjaeab.mapick.layer.LayerRepository;
import com.gitsunjaeab.mapick.layer_library.LayerLibraryService;
...
@RestController
@RequestMapping(value = "/layerLibraries", produces = MediaType.APPLICATION_JSON_VALUE)
public class LayerLibraryController {
    ...
    public LayerLibraryController(final LayerLibraryService layerLibraryService,
    ...
    public ResponseEntity<Map<Long, String>> getLayerValues() {
        return ResponseEntity.ok(layerRepository.findAll(Sort.by("id"))
                .stream()
                .collect(CustomCollectors.toSortedRoadmap(Layer::getId, Layer::getName)));
    }
