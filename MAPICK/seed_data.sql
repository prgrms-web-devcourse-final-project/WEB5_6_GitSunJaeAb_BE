...
INSERT INTO public.roadmaps (is_animated, is_public, like_count, view_count, category_id,
                             created_at, deleted_at, id, member_id, updated_at,
                             description, roadmap_type, thumbnail, title)
VALUES (true, true, 15, 70, 1, '2025-07-11 10:46:52.000000 +00:00', null, 1, 1,  null,
        '잠실 주변 맛집 내가 추천해줄게', 'PERSONAL', null, '잠실 주변 맛집'),
       (true, true, 35, 100, 2, '2025-07-11 10:51:46.000000 +00:00', null, 2, 1,  null,
        '서울시와 함께 하는 야경 맛집 스팟', 'SHARED', null, '서울시 야경 맛집'),
       (true, false, 1, 3, 3, '2025-07-11 10:53:21.000000 +00:00', null, 3, 1,  null,
        '8/11-8/12 여름 삿포로 여행', 'PERSONAL', null, '여름 일본 여행'),
       (false, true, 3, 45, 2, '2025-07-13 17:42:59.736000 +00:00', null, 4, 2,  null,
        '이번 겨울 온천여행은 여기로~!', 'PERSONAL', null, '겨울 온천 여행'),
       (false, false, 86, 18, 1, '2025-07-13 17:05:00.000000+00:00', null, 5, 3,  null,
        '설명 5번 - 자동 생성된 설명입니다.', 'PERSONAL', null, '로드맵 5번 타이틀'),
       (false, true, 5, 238, 3, '2025-07-13 17:06:00.000000+00:00', null, 6, 1, null,
        '설명 6번 - 자동 생성된 설명입니다.', 'SHARED', null, '로드맵 6번 타이틀'),
       (true, true, 92, 101, 4, '2025-07-13 17:07:00.000000+00:00', null, 7, 2,  null,
        '설명 7번 - 자동 생성된 설명입니다.', 'PERSONAL', null, '로드맵 7번 타이틀'),
       (false, true, 0, 164, 2, '2025-07-13 17:08:00.000000+00:00', null, 8, 1,  null,
        '설명 8번 - 자동 생성된 설명입니다.', 'SHARED', null, '로드맵 8번 타이틀'),
       (false, true, 12, 70, 8, '2025-07-19 11:00:00+00', null, 9, 3, null,
        '혼자 걷기 좋은 서울숲 & 한강 코스', 'PERSONAL', null, '서울 산책 로드'),
       (true, true, 42, 150, 9, '2025-07-19 11:10:00+00', null, 10, 4, null,
        '영화 덕후를 위한 고전 명작 소개', 'SHARED', null, '고전 영화 투어'),
       (true, true, 18, 90, 10, '2025-07-19 11:20:00+00', null, 11, 2, null,
        '8월 전국 축제 모음집', 'SHARED', null, '여름 축제 로드맵');
