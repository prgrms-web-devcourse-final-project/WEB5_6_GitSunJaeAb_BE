...
public class MarkerController {
    ...
    public ResponseEntity<MarkerResponse> getMarker(
        ...
        MarkerDTO dto = markerService.getMarker(markerId);
        MarkerResponse response = MarkerResponse.of(dto);
    ...
    public ResponseEntity<ApiResponse> updateMarker(
        @PathVariable(name = "markerId") final Long markerId,
...
//        markerService.update(markerId, markerDTO);
    ...
    public ResponseEntity<ApiResponse> deleteMarker(
        @PathVariable(name = "markerId") final Long markerId) {
